...
foreach ($getdata as $data) {
	...
	// $automail->insert_TruckingLog($data['SALESID'],$closetime,$grossweight,$std20_,$std40_,$hc40_,$lcl_,$hc45_);
		...
		// echo "is sent mail";
	 	if (!isset($email_To['sender'][0])) {
			...
			if ($mail['result'] === true) {	
				...
				// $automail->insert_Trucking($data['SALESID'],$cy,$rtn,$cyterminalname,$rtterminalname,$paperless,$shippingline,$feeder,$feedervoy,$vessel,$vesselvoy,$loadingplant,$closedate,$closetime,$cutoffvgmdate,$cutoffvgmtime,$bookingno,$loadingdate,$primarycontactid,$forwarder,$cycontact,$cytel,$rtcontact,$rttel,$etd,$eta,$port,$place,$transshipment,$grossweight,$truckagent,$truckremark);
